                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="text-center fw-bold" style="margin-top:-30px; font-size: 20px;">Đăng nhập</p>
                                
                                <?php 
                                // Biến $login_error được truyền từ Controller
                                // ⭐ SỬA LỖI: Kiểm tra xem $login_error có tồn tại và không rỗng
                                ...
                                <form method="post" action="/Webbanhang/Admin/view/Entry.php"> 
                                    <div class="mb-3">
